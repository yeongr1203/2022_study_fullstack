...
<body>
    <div class="container">
        <figure class="figure">
            <img class="figure-img img-fluid rounded"  src="https://i.picsum.photos/id/146/500/300.jpg?hmac=fNhZnoVQ9JUxqt1xwhtat-R6yyuQ6FZI-OAOSP2FD2g" alt="...">
            <figcaption class="figure-caption text-end">A caption for the above image.</figcaption>
            <!-- text-end : 글자 오른쪽에 정렬됨. img기준. // 만약 figure태그가 아닌 div였다면 body의 맨 오른쪽 끝에 붙었을 것.-->
        </figure>
    </div>
</body>
